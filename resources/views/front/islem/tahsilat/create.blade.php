    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form method="post" enctype="multipart/form-data" action="{{route("islem.store",["type" => 1])}}">
                    <div class="row p-3">
                    ...
                    <div class="col-12 mr-3 mb-3">
                        <input type="submit" value="Yeni Tahsilat Oluştur" class="btn btn-success float-right">
                    </div>
                </form>
            </div>
            <!-- /.card -->
